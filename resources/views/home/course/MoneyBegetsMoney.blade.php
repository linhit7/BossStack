...
<div class="fiinves-coaching second">
@if(isset($infor))
                ...
                <div class="list-item">
                    <ul>
                        <li>
                            ...
                            <span class="text">Chưa biết cách xử lý thu nhập của mình để tối ưu nhất.</span>
                        </li>
                        ...
                        <li>
                            ...
                            <span class="text">Có một ít tiền nhưng không biết cách tạo ra thêm tiền.</span>
                        </li>
                        ...
                        <li>
                            ...
                            <span class="text">Muốn bức tranh tài chính phong phú và về hưu sớm hơn dự kiến.</span>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="content">
                            ...
                            <p>
                                <i class="fas fa-check"></i>Nghiên cứu phương pháp trả nợ, gửi tiết kiệm có lợi nhất cho bạn.<br>
                                <i class="fas fa-check"></i>Phát triển dòng tiền hoặc đa dòng tiền cho kế hoạch nghỉ hưu.<br>
                                <i class="fas fa-check"></i>Thực hiện đầu tư có kế hoạch, không ảnh hưởng đến đời sống thường nhật.<br>
                            </p>
                            ...
                            <p class="highlight-text">Vậy còn chờ gì nữa, trở thành thành viên BossStacker ngay hôm nay với khóa học <b>"Coaching 1:1 - Tiền Đẻ Ra Tiền"</b> tại BossStack thôi!</p>
                        </div>
                    </div>
                </div>
            </div>
