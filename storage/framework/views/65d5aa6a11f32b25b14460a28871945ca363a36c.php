...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('applicationmodules-store'), false); ?>?index=true" method="post" id="frm">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="applicationmodulename" value="<?php echo e(old('applicationmodulename'), false); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" tabindex="4" name="hidden" value="1" id="chk-hidden" <?php echo e(old('hidden')==1 ? 'checked="checked"' : '', false); ?>>
                    </div>                      
                    <div class="form-group">
