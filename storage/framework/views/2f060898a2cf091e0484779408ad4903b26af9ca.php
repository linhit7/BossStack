...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('payrolls-update', ['id' => $model->id]), false); ?>?continue=false" method="post" id="frm">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="worksalary" onkeyup='this.value=formatNumberDecimal(this.value)' value="<?php echo e(formatNumber($model->worksalary, 1, 0, 0), false); ?>">
                            <?php if($errors->has('worksalary')): ?><span class="text-danger"><?php echo e($errors->first('worksalary'), false); ?></span><?php endif; ?>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Phụ cấp: </label>
                            <input type="text" class="form-control" name="extrasalary" onkeyup='this.value=formatNumberDecimal(this.value)' value="<?php echo e(formatNumber($model->extrasalary, 1, 0, 0), false); ?>">
                        </div>
                    </div>
