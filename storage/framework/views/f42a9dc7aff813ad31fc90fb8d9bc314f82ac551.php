                                    ...
                                    <form role="form" action="<?php echo e(route('customers-addCustomer')); ?>?continue=true" method="post" id="customer-form">
                                        <div class="box box-primary">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <input type="text" hidden="true" name="id" value="<?php echo e($idUser); ?>">
                                                <div class="form-group">
                                                    <label>Họ & tên <small class="text-danger text"> (*)</small>:</label>
                                                    <input type="text" class="form-control" name="name" value="<?php echo e($userCustomer->name); ?>" readonly="">
                                                </div>

                                                <div class="form-group">
                                                    <label>Email <small class="text-danger text"> (*)</small>:</label>
                                                    <input type="text" class="form-control" name="email" value="<?php echo e($userCustomer->email); ?>" readonly="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="re_password" type="password" class="form-control" name="re_password" value="<?php echo e(old('password')); ?>">
                                                </div>
                                            </div>
    ...
    <script>
    	$(function(){
    		$('.btn-register').click(function() {
		        ...
		        $.get('<?php echo e(route('customers-updateChangePass',['id' => $idUser])); ?>', {password: password, re_password: re_password }, function(data) {
