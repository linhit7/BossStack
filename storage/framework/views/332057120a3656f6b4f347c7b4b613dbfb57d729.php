    ...
    <div class="col-xs-12">
        <div class="box box-saving">      
            ...
            <div class="box-body">
                ...
                <?php echo $__env->make('product-manage.saving.partials.search-form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <div class="form-group">
...
<?php echo $__env->make('product-manage.saving.partials.script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
