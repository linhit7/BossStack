    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Danh sách quan hệ nhân thân</h3>
                <div class="box-tools">
                    <a href="<?php echo e(route('familyrlships-add', ['employeeid' => $employeeid]), false); ?>" class="btn btn-default"><i class="fa fa-plus" aria-hidden="true"></i> Tạo mới</a>
                </div>
            </div>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th width="6%" style="text-align: center;">Quan hệ</th>
                            <th width="20%" style="text-align: center;">Họ tên</th>
                            <th width="18%" style="text-align: center;">Ngày sinh</th>
                            <th width="20%" style="text-align: center;">Địa chỉ</th>
                            <th style="text-align: center;">Công việc / Điện thoại liên lạc</th>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="text-align: center;"><?php echo e($relationshiptype[$model->relation], false); ?></td>
                                <td style="text-align: left;"><?php echo e($model->fullname, false); ?></td>
                                <td style="text-align: center;"><?php echo e($model->birthday == null ? "" : date("d/m/Y", strtotime($model->birthday)), false); ?></td>
                                <td style="text-align: left;"><?php echo e($model->address, false); ?></td>
                                <td style="text-align: left;"><?php echo e($model->work, false); ?></td>
                                <td style="text-align: center;">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="<?php echo e(route('familyrlships-edit', ['employeeid' => $employeeid, 'id'=> $model->id]), false); ?>"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
                                            <li><a href="javascript:void(0)" data-id="<?php echo e($model->id, false); ?>" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                                <form style="margin: 0;" name="form-delete-<?php echo e($model->id, false); ?>" method="post" action="<?php echo e(route('familyrlships-delete', ['employeeid' => $employeeid, 'id' => $model->id]), false); ?>">
