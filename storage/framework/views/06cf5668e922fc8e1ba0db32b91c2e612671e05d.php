...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('applicationroles-update', ['id' => $model->id]), false); ?>?continue=true" method="post" id="frm">
                    ...
                    <div class="form-group">
                        <label>Module truy cập <small class="text-danger text"> (*)</small>: </label><br>
                            <?php $__currentLoopData = $applicationmodules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <input type="checkbox" name="modules_<?php echo e($item->id, false); ?>" value="<?php echo e($item->id, false); ?>" <?php echo e(in_array($item->id,$modulesallowed) ? 'checked' : '', false); ?>> <br> 
