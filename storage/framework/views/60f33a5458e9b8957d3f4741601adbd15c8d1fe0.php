...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('applicationresources-store')); ?>?index=true" method="post" id="frm">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="code" value="<?php echo e($code); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="filename" value="<?php echo e(old('filename')); ?>">
                    </div>                                      
                    <div class="form-group">
                        <label>Page security : </label>
                        <input type="text" class="form-control" name="pagesecurity" value="<?php echo e($pagesecurity); ?>">
                    </div>                                      
                    <div class="form-group">
                        <label>Image : </label>
    ...
    <div class="col-md-4">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <a href="<?php echo e(route('applicationresources-index')); ?>" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
            </div>
        </div>
    </div>
</div>
