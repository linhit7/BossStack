    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            <header class="main-header">
                <!-- Logo -->
                <a href="<?php echo e(route('dashboard'), false); ?>" class="logo">
                    <span class="logo-mini"><img src="<?php echo e(asset('dist/img/icon-rb-white.png'), false); ?>" alt="RB" style="width: 30px;"></span>
                    <span class="logo-lg"><!--<b><?php echo e(config('app.name'), false); ?></b>--><img src="<?php echo e(asset('dist/img/logo_png.png'), false); ?>" alt="<?php echo e(config('app.name'), false); ?>" style="width: 135px;"></span>
                </a>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>
                        <?php echo e($title->heading, false); ?>

                        <small><?php echo e($title->sub_heading, false); ?></small>
                    </h1>
