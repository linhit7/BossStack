...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('applicationresources-update', ['id' => $model->id])); ?>?continue=true" method="post" id="frm">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="filename" value="<?php echo e($model->filename); ?>">
                    </div>                                           
                    <div class="form-group">
                        <label>Page security : </label>
                        <input type="text" class="form-control" name="pagesecurity" value="<?php echo e($model->pagesecurity); ?>">
                    </div>                                           
                    <div class="form-group">
                        <label>Image : </label>
