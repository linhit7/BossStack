    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Danh sách hợp đồng lao động nhân viên</h3>
                <div class="box-tools">
                    <a href="<?php echo e(route('laborcontracts-add', ['employeeid' => $employeeid]), false); ?>" class="btn btn-default"><i class="fa fa-plus" aria-hidden="true"></i> Tạo mới</a>
                </div>
            </div>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th width="18%" style="text-align: center;">Hợp đồng</th>
                            <th width="18%" style="text-align: center;">Từ ngày</th>
                            <th width="18%" style="text-align: center;">Đến ngày</th>
                            <th width="20%" style="text-align: center;">Số hợp đồng</th>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="text-align: left;"><?php echo e($labortype[$model->labortype], false); ?></td>
                                ...
                                <td style="text-align: center;">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="<?php echo e(route('laborcontracts-edit', ['employeeid' => $employeeid, 'id'=> $model->id]), false); ?>"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
                                            <li><a href="javascript:void(0)" data-id="<?php echo e($model->id, false); ?>" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                                <form style="margin: 0;" name="form-delete-<?php echo e($model->id, false); ?>" method="post" action="<?php echo e(route('laborcontracts-delete', ['employeeid' => $employeeid, 'id' => $model->id]), false); ?>">
