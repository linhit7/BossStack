    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Quá trình đóng bảo hiểm xã hội</h3>
                <div class="box-tools">
                    <a href="<?php echo e(route('insurances-add', ['employeeid' => $employeeid]), false); ?>" class="btn btn-default"><i class="fa fa-plus" aria-hidden="true"></i> Tạo mới</a>                    
                </div>
            </div>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th width="18%" style="text-align: center;">Mức lương đóng BHXH</th>
                            <th width="18%" style="text-align: center;">Phụ cấp đóng BHXH</th>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="text-align: right;"><?php echo e(formatNumber($model->salaryinsurance, 1, 0, 0), false); ?></td>
                                <td style="text-align: right;"><?php echo e(formatNumber($model->extrainsurance, 1, 0, 0), false); ?></td>
                                ...
                                <td style="text-align: center;">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="<?php echo e(route('insurances-edit', ['employeeid' => $employeeid, 'id'=> $model->id]), false); ?>"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
                                            <li><a href="javascript:void(0)" data-id="<?php echo e($model->id, false); ?>" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                                <form name="form-delete-<?php echo e($model->id, false); ?>" method="post" action="<?php echo e(route('insurances-delete', ['employeeid' => $employeeid, 'id' => $model->id]), false); ?>" style="margin: 0;">
