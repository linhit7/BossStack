...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('applicationresources-store'), false); ?>?index=true" method="post" id="frm">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="code" value="<?php echo e($code, false); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="filename" value="<?php echo e(old('filename'), false); ?>">
                    </div>                                      
                    <div class="form-group">
                        <label>Page security : </label>
                        <input type="text" class="form-control" name="pagesecurity" value="<?php echo e($pagesecurity, false); ?>">
                    </div>                                      
                    <div class="form-group">
                        <label>Image : </label>
