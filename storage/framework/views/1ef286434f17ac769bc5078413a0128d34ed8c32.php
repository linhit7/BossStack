...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo e(route('dashboard'), false); ?>"><b><?php echo e(config('app.name'), false); ?></b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <form action="<?php echo e(route('login'), false); ?>" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Password" name="password" required="required" value="<?php echo e(env('TEST_PASSWORD'), false); ?>">
