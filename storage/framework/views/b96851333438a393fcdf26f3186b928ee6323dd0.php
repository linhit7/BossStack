                ...
                <div class="box-tools">
                    <div class="btn-group btn-group-sm">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="<?php echo e(route('usercustomers-export')); ?>"><i class="fa fa-file-text-o" aria-hidden="true"></i> Xuất tất cả</a></li>
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="<?php echo e(route('usercustomers-index', filter_data($filter, 'orderBy', 'id'))); ?>">Mã người dùng</a></li>
                                <li><a href="<?php echo e(route('usercustomers-index', filter_data($filter, 'orderBy', 'name'))); ?>">Tên</a></li>
                                <li><a href="<?php echo e(route('usercustomers-index', filter_data($filter, 'orderBy', 'email'))); ?>">Email</a></li>
                                <li><a href="<?php echo e(route('usercustomers-index', filter_data($filter, 'orderBy', 'created_at'))); ?>">Ngày tạo</a></li>
                                <li><a href="<?php echo e(route('usercustomers-index', filter_data($filter, 'orderBy', 'updated_at'))); ?>">Ngày chỉnh sửa</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="<?php echo e(route('usercustomers-index', filter_data($filter, 'sortedBy', 'asc'))); ?>"><i class="fa fa-sort-amount-asc" aria-hidden="true"></i> Tăng dần</a></li>
                                <li><a href="<?php echo e(route('usercustomers-index', filter_data($filter, 'sortedBy', 'desc'))); ?>"><i class="fa fa-sort-amount-desc" aria-hidden="true"></i> Giảm dần</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('user-employees.user.user_account_customer.add', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
