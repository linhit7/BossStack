<div class="box box-default">
    <form role="form" action="<?php echo e(route('checkemployeemonths-process'), false); ?>"  method="post" id="frmsearch">
    <?php echo e(csrf_field(), false); ?> 
    <input type='hidden' name='typereport' value=''>
        <div class="box-header with-border">
            <h3 class="box-title">Chọn tháng/năm cần tổng hợp chấm công tháng</h3>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-xs-2">
        ...
        <div class="box-footer text-left">
            ...
            <button class="btn btn-primary btn-search" onclick="processReports('frmsearch', 'view')">Xem bảng chấm công đã lưu</button>
        </div>
    </form>
</div>