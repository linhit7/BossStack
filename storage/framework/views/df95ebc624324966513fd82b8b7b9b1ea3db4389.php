...
<div class="status">
    <b class="alert alert-warning">Tổng số yêu cầu: <?php echo e($totalRequest); ?></b>
    <b class="alert alert-success">Đã xử lý: <?php echo e($totalRequested); ?></b>
    <b class="alert alert-danger">Thông tin chờ xử lý: <?php echo e($totalRequesting); ?></b>
</div>
		                        ...
		                        <?php $__currentLoopData = $collections->where('type', 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advisory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			                        <tr>
			                            ...
			                            <td class="text-center">
			                            	<a data-toggle="modal" class="advisory-answers" data-route="<?php echo e(route('advisory-answers', ['id' => $advisory->id])); ?>" href="#answerEmail">
						...
						<table class="table table-hover">
		                    ...
		                    <tbody>
		                        ...
		                        <?php $__currentLoopData = $collections->where('type', 0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $website): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			                        <tr>
			                            <td class="text-center">Gấp</td>
			                            <td class="text-center"><?php echo e($website->fullname); ?></td>
			                            <td class="text-center"><?php echo e($website->email); ?></td>
			                            <td class="text-center"><?php echo e($website->phone); ?></td>
			                            <td>
			                            	<p><b>Tiêu đề: </b><?php echo e($website->titleadvisory); ?></p>
			                            	<p><b>Nội dung: </b><?php echo e($website->contentadvisory); ?></p>
			                            </td>
			                            <td class="text-center">
			                            	<a data-toggle="modal" class="advisory-answers" data-route="<?php echo e(route('advisory-answers', ['id' => $website->id])); ?>" href="#answerEmail">
			                            		<i class="fas fa-undo-alt"></i> Trả lời
			                            	</a>
			                            </td>
			                            <td class="text-center"><?php echo e($website->advisoryAnswer == NULL ? "" : $website->advisoryAnswer->user()->first()->name); ?></td>
