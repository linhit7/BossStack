    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-header">
                ...
                <div class="box-tools">
                    <a href="<?php echo e(route('applicationfunctiongroups-add', ['applicationmoduleid' => $applicationmoduleid])); ?>" class="btn btn-default"><i class="fa fa-plus" aria-hidden="true"></i> Tạo mới</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="text-align: center;"><a href="<?php echo e(route('functionassignment-index', ['applicationmoduleid'=> $applicationmoduleid, 'applicationfunctiongroupid'=> $model->id])); ?>">Chức năng</a></td>
                                <td style="text-align: center;">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="<?php echo e(route('applicationfunctiongroups-edit', ['applicationmoduleid' => $applicationmoduleid, 'id'=> $model->id])); ?>"><i class="fas fa-pencil-alt" style="margin-right: 10px;"></i> Chỉnh sửa</a></li>
                                            <li><a href="javascript:void(0)" data-id="<?php echo e($model->id); ?>" class="btn-delete"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                                <form style="margin: 0;" name="form-delete-<?php echo e($model->id); ?>" method="post" action="<?php echo e(route('applicationfunctiongroups-delete', ['applicationmoduleid' => $applicationmoduleid, 'id' => $model->id])); ?>">
...
<div>
    <a href="<?php echo e(route('applicationmodules-index')); ?>" class="btn btn-default btn-cancel" style="width: 8%;"><i class="fa fa-arrow-left"></i> Quay lại</a>   
</div>
