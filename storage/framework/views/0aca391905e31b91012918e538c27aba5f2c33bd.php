...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('securityresources-store')); ?>?index=true" method="post" id="frm">
                <input type="hidden" name="resourcecode"  value="<?php echo e($applicationresourceid); ?>">
                <?php echo e(csrf_field()); ?>

                <div class="box-body">
                    <div class="form-group">
                        <label>Trang truy cập <small class="text-danger text"> (*)</small>:</label><br>
                        <font size=2><?php echo e($applicationresourceid . '. ' . $applicationresources->name); ?></font>
                    </div>                      
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="rolecode">
                            ...
                            <?php if($errors->has('rolecode')): ?><span class="text-danger"><?php echo e($errors->first('rolecode')); ?></span><?php endif; ?>
                        </select>
                    </div>                     
                    <div class="form-group">
                        <label>View:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cview" value="1" <?php echo e(old( 'cview')==1 ? 'checked="checked"' : ''); ?>>
                    </div>  
                    <div class="form-group">
                        <label>Add:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cadd" value="1" <?php echo e(old( 'cadd')==1 ? 'checked="checked"' : ''); ?>>
                    </div> 
                    <div class="form-group">
                        <label>Delete:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cdelete" value="1" <?php echo e(old( 'cdelete')==1 ? 'checked="checked"' : ''); ?>>
                    </div> 
                    <div class="form-group">
                        <label>Update:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cupdate" value="1" <?php echo e(old( 'cupdate')==1 ? 'checked="checked"' : ''); ?>>
                    </div> 
                    <div class="form-group">
                        <label>Approve:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="capprove" value="1" <?php echo e(old( 'capprove')==1 ? 'checked="checked"' : ''); ?>>
                    </div> 
                        ...
                        <select class="form-control select2" multiple id="cuserview" name="cuserview[]">                        
                            ...
                            <?php if( old('cuserview') != null ): ?>
                                <?php if( in_array($item->id, old('cuserview')) ): ?>
                                    <option value="<?php echo e($item->id); ?>" selected><?php echo e($item->id . '. ' . $item->name); ?></option>
                                <?php endif; ?>
                            <?php else: ?>
    ...
    <div class="col-md-4">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <a href="<?php echo e(route('securityresources-index', ['applicationresourceid'=>$applicationresourceid])); ?>" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
            </div>
        </div>
    </div>
</div>
