...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('securityresources-update', ['id' => $model->id]), false); ?>?continue=true" method="post" id="frm">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="rolecode">
                            ...
                            <?php $__currentLoopData = $applicationroles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($item->code == $model->rolecode): ?>
                    ...
                    <div class="form-group">
                        <label>View:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cview" value="1" <?php echo e($model->cview==1 ? 'checked="checked"' : '', false); ?>>
                    </div>  
                    <div class="form-group">
                        <label>Add:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cadd" value="1" <?php echo e($model->cadd==1 ? 'checked="checked"' : '', false); ?>>
                    </div> 
                    <div class="form-group">
                        <label>Delete:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cdelete" value="1" <?php echo e($model->cdelete==1 ? 'checked="checked"' : '', false); ?>>
                    </div> 
                    <div class="form-group">
                        <label>Update:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="cupdate" value="1" <?php echo e($model->cupdate==1 ? 'checked="checked"' : '', false); ?>>
                    </div> 
                    <div class="form-group">
                        <label>Approve:&nbsp;&nbsp;</label>
                        <input type="checkbox" tabindex="4" name="capprove" value="1" <?php echo e($model->capprove==1 ? 'checked="checked"' : '', false); ?>>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <SELECT class="form-control select2" multiple id="cuserview" name="cuserview[]">                        
                            ...
                            <?php if(in_array($item->id, $model->cuserview)): ?>
    ...
    <div class="col-md-4">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <a href="<?php echo e(route('securityresources-index', ['applicationresourceid'=> $model->resourcecode]), false); ?>" class="btn btn-default btn-cancel" tabindex="6">Trở về</a>
            </div>
        </div>
    </div>
</div>
