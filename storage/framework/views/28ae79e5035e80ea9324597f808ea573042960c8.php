...
<div class="row">
    <div class="col-md-8">
        <div class="box box-primary">
            ...
            <form role="form" action="<?php echo e(route('educations-update', ['id' => $model->id]), false); ?>?continue=false" method="post" id="frm">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="schoolname" value="<?php echo e($model->schoolname, false); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="major" value="<?php echo e($model->major, false); ?>">
                    </div>                                           
                    <div class="form-group">
